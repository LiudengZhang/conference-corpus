...
The original bibliography in §11.3 leaned 2024–2025. Below are **29 papers and models** from mid-2025 through Q2 2026 that materially affect the talk's argument. Each is annotated with **what changed because of it** and **which section it should be folded into when re-delivering**.
...
- **§4.1 evidence base is now eight papers, not three.** Ahlmann-Eltze, Kedzierska, Wenkel, Wu *Nat Methods*, Wu *Genome Biol*, Liu *Adv Sci*, parameter-free bioRxiv, PertEval-scFM, CellBench-LS, Han et al., cellular-dynamics zero-shot. The reckoning has moved from "three independent papers" to "a discipline-wide consensus that single-cell FMs don't yet earn the linear-baseline floor across most downstream tasks."
...
- **§10 closing.** The Bunne *Cell* "Turing test" framing + the Theis *Cell Systems* "compositional FMs" framing are the two cleanest closers — Bunne sets the bar, Theis names the next direction.
...
- **Agentic-AI ↔ virtual-cell convergence** is now publicly model-backed (rBio). The §8 commercial framing should note that the CZ Biohub stack (TranscriptFormer + rBio + Virtual Cell Platform) is the only fully-open competitor to the closed commercial agents from Owkin / Modella AI.
