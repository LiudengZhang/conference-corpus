...
- **[MedAgentGym](../../conferences/iclr-2026/tools/medagentgym.md)** (ICLR 2026, AACR-relevant) — 72k-task sandboxed code-exec gym with Med-Copilot-7B orchestrating biomedical analyses. The agent writes code to call scikit-learn, run scanpy, query databases. **The substrate for training agents that use bio-FMs as tools.**
...
- **[AACR 2026 AT02 session](../../conferences/aacr-2026/sessions/2026-04-21-at02-agentic-ai-cancer-researcher.md)** — "Agentic AI as the Cancer Researcher."
- **[AACR 2026 4/22 Oncologist session](../../conferences/aacr-2026/sessions/2026-04-22-agentic-ai-as-the-oncologist.md)** — clinical-AI-as-agent angle.
- **[ICLR 2026 MedAgentGym dossier](../../conferences/iclr-2026/tools/medagentgym.md)** — the agent-substrate for biomedical analyses.
