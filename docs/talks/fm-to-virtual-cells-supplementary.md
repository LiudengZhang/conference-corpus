...
- **[Mahmood Lab](https://faisal.ai/)** (Harvard / BWH / MGB) — PI Faisal Mahmood. Ships a *fleet* rather than a single FM: UNI / UNI2-h, CONCH, PathChat / PathChat-DX, TITAN, CHIEF, [HEST-1k](https://github.com/mahmoodlab/HEST). **Disclosure norm**: opaque on compute; HF gating tightened Jan 2025. Strategic move 2025: PathChat-DX FDA Breakthrough Designation — first generative-AI pathology tool. AACR 2026: [ISBI 2026 keynote](../conferences/isbi-2026/tools/mahmood-pathology-fm-keynote.md) on the three-tier FM stack.
...
- **[Bo Wang Lab](https://wanglab.ai/)** (U. Toronto / Vector / UHN) — PI Bo Wang. Ships: scGPT, scGPT-spatial, MedSAM, BulkRNABERT. **Disclosure norm**: opaque on scGPT training compute (50× uncertainty band). Strategic move 2025: explicit agentic-AI pivot — Wang's [AACR 2026 talk](../conferences/aacr-2026/sessions/2026-04-20-am-ai-revolution-in-cancer-research.md) is framed around clinical agents.
...
- [AACR 2026 Virtual Cells topic](../conferences/aacr-2026/topics/virtual-cells/index.md).
- [AACR 2026 Agentic AI topic](../conferences/aacr-2026/topics/agentic-ai/index.md).
- [AACR 2026 Bioinfo/AI methods topic](../conferences/aacr-2026/topics/bioinfo-tools/index.md).
- [ICLR 2026 tools](../conferences/iclr-2026/index.md).
- [ISBI 2026 pathology FM keynote](../conferences/isbi-2026/tools/mahmood-pathology-fm-keynote.md).
- [JPM 2026 themes](../conferences/jpm-2026/themes.md).
